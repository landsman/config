...
| `os/windows/` | Windows 11 on the T480 — power settings and registry policies, see [its README](os/windows/README.md) | `apply.ps1`, not stowable |
...
- [Windows 11](os/windows/README.md) — one script for power settings and policies, and why Windows Update no longer restarts while I am signed in
