...
| `os/windows/` | Windows 11 on the T480 — registry policies, see [its README](os/windows/README.md) | by hand, not stowable |
...
- [Windows 11](os/windows/README.md) — why Windows Update no longer restarts while I am signed in
