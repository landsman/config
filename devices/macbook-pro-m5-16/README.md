...
| Path | What |
|------|------|
| `devices/macbook-pro-m5-16/` (this package) | Nothing stowed yet — only for config that needs *this* hardware |
...
*not* land there — a `docs/` directory, say — has to be listed in a
