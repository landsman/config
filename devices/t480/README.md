...
- [Hardware](docs/hardware.md) — specs, operating systems, and how to re-read
  them
- [Upgrades / to consider](docs/upgrades.md) — planned and parked hardware
  changes
...
Files here are symlinked into `$HOME` by `make stow`, so anything that is _not_
